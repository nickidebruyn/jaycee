(function () {
  ...
  function QuoteCreateController ($location, $routeParams, validationUtils) {
    ...
    function addDocumentFooter(doc, startY) {
      ...
      doc.addImage(signData, 'JPEG', 10, startY + 52, 30, 26);

      doc.text(10, startY + 52 , "REGARDS");
      doc.text(143, startY + 52 , "STD BANK GEZINA");
      doc.text(143, startY + 56 , "ACC: 011 787295");
      doc.text(143, startY + 60 , "BRANCH: 014845");

      doc.setFontType("helvetica");
      doc.text(10, startY + 56 , "Jan Clemons");
      doc.text(10, startY + 60 , "082 775 0156");
